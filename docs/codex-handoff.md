...
Build on top of the existing starter repo.
...
6. Improve project page with screenshot slots and architecture diagram.
7. Protect mutating routes in production.
8. Add proper metadata and Open Graph tags.
