...
export const projects: ProjectEntry[] = [
  ...
  },
  {
    ...
    appHref: "https://email-engine.app/esp/visitor",
    status: "live",
    artifacts: {
      outcomeStrip: [
      ...
      evidenceLinks: [
        { label: "Live admin", href: "https://email-engine.app/esp/visitor", detail: "Opens the deployed Email Engine admin console." },
