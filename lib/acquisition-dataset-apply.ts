      ...
      await tx.acquisitionAuditLog.create({
        data: {
          ...
          metadata: {
            ...
            appliedCampaignName: campaignName,
            rowCounts: dataset.rowCounts,
            provider: datasetMetadata.provider ?? null,
            providerLabel: datasetMetadata.providerLabel ?? null,
            externalAccountId: datasetMetadata.externalAccountId ?? null,
            accountName: datasetMetadata.accountName ?? null,
            externalCampaignId: datasetMetadata.externalCampaignId ?? null,
            campaignName: datasetMetadata.campaignName ?? null,
            externalAdGroupId: datasetMetadata.externalAdGroupId ?? null,
            adGroupName: datasetMetadata.adGroupName ?? null,
            childScopeType: datasetMetadata.childScopeType ?? null,
            connectionId: datasetMetadata.connectionId ?? null,
            syncScope: datasetMetadata.syncScope ?? null,
            syncedAt: datasetMetadata.syncedAt ?? null,
            snapshotSource: datasetMetadata.snapshotSource ?? null,
