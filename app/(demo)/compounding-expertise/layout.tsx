...
import { CompoundingActiveAnalysisVisibility } from "@/components/compounding-expertise/CompoundingActiveAnalysisVisibility";
...
export default async function CompoundingExpertiseLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <DemoAppShell app="compounding-expertise">
      <CompoundingActiveAnalysisVisibility>
