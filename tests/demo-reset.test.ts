...
test("resolveDemoResetRequest accepts lifecycle, acquisition, auction, pricing, retention, and expansion scopes", () => {
  ...
  assert.deepEqual(resolveDemoResetRequest({ confirm: "RESET_DEMO", scope: "expansion" }), {
    ok: true,
    scope: "expansion"
  });
});
